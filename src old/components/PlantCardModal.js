        ...
        <div className="p-6">
          ...
          {bulkCareMode && (
            <div className="flex items-center mb-4 p-3 bg-purple-50 rounded-lg">
              ...
              >
                {isSelected ? 'Selected for bulk actions' : 'Click to select for bulk actions'}
              </label>
            </div>
          )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className={`p-4 bg-gray-50 rounded-lg ${
              bulkCareMode && !isSelected ? 'opacity-70' : ''
            }`}>
              ...
              <div className="space-y-2 text-sm">
                ...
                <p><span className="font-medium">Acquired:</span> {plant.acquisitionDate}</p>
