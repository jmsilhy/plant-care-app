    ...
    <div className="max-w-6xl mx-auto p-4 md:p-6">
      {viewingPlantId ? (
        ...
        <>
          ...
          {plants.length > 0 ? (
            <>
              {/* Instructions for mobile users - only show on mobile */}
              <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg md:hidden">
                <p className="text-sm text-green-700 text-center">
                  <span className="font-medium">💡 Tap any card</span> to expand and see details, care actions & management options
                </p>
              </div>
